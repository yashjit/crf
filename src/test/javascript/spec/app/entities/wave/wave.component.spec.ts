  ...
  describe('Wave Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WaveComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.waves && comp.waves[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
